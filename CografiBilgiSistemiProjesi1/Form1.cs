...
namespace CografiBilgiSistemiProjesi1
{
    public partial class Form1 : Form
    {
        ...
        private void aracListesiniOlustur()
        {
            ...
            list.Add(new Arac("35AC02", "Kamyon", "İzmir", "İstanbul", new PointLatLng(39.22, 27.67)));
            list.Add(new Arac("38AC03", "Hafif Ticari", "Ankara", "İstanbul", new PointLatLng(40.67, 30.24)));
            list.Add(new Arac("61AC04", "Tır", "İstanbul", "Ankara", new PointLatLng(40.05, 32.22)));
            list.Add(new Arac("34AC08", "Kamyon", "Ankara", "İzmir", new PointLatLng(38.75, 30.43)));
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Markerları önce eklersek yanlış yere koyabilir.
